...
import game.snake.Screen.GameScreen;
...
public class Snake {
    ...
    public void initialize() {
        ...
        if(GameScreen.getContinued()){
            ...
            for(int i = 0; i < GameScreen.getPrefs().getInteger("numberOfSegments"); i++){
                snakeSegments.add(new GridPoint2(GameScreen.getPrefs().getInteger("snakeX["+i+"]"),
                        GameScreen.getPrefs().getInteger("snakeY["+i+"]")));
            }
    ...
    public void act(float deltaTime) {
        ...
        if(Score.getScore() < 100) {
            ...
            timeElapsedSinceLastMove += deltaTime/0.8;
        }
        else{
            timeElapsedSinceLastMove += deltaTime/0.5;
        }
